...
{
    [TestClass]
    public class AdvancedDirectoryServiceValidatorTests
    {
        ...
        private readonly AdvancedPoliciesValidator _advancedValidator = new AdvancedPoliciesValidator();

        public AdvancedDirectoryServiceValidatorTests()
        {
            // 2048 Bit RSA Key
            ...
            _policy = new CertificateRequestPolicy
            {
                ...
                AdvancedPolicy = new List<AdvancedPolicy>
                {
                    new AdvancedPolicy
                    {
                        Action = "Issue",
                        PolicyName = "Require groups",
                        AdvancedADPolicy = new List<AdvancedADPolicy>
                        {
                            new AdvancedADPolicy
                            {
                                GroupMembership = new List<string> { "CN=PKI_UserCert,OU=ADCSLabor Gruppen,DC=intra,DC=adcslabor,DC=de" },
                                PermitDisabledAccounts = false
                            }
                        }
                    },
                    new AdvancedPolicy
        ...
        */
        ...
        {
            var policy = _policy;
            policy.AdvancedPolicy[0].AdvancedADPolicy[0].PermitDisabledAccounts = true;

            var result = new CertificateRequestValidationResult(_dbRow);
            result = _advancedValidator.VerifyRequest(result, _policy.AdvancedPolicy, _dbRow, _dsObject2, null);
        ...
        public void Allow_if_member_of_allowed_group()
        {
            ...
            result = _advancedValidator.VerifyRequest(result, _policy.AdvancedPolicy, _dbRow, _dsObject, null);
        ...
        public void Deny_if_member_of_forbidden_group()
        {
            ...
            policy.AdvancedPolicy.Insert(0, new AdvancedPolicy { Action = "Reject", PolicyName = "Reject for group test", AdvancedADPolicy = { new AdvancedADPolicy { GroupMembership = new List<string> { "test" } } } }); 
